  ...
  return (
    <Flex>
     {/*  <IconButton onClick={onPresent1} variant="text" scale="sm" mr="4px">
      ...
      <IconButton onClick={onPresent2} variant="text" scale="sm" width="fit-content !important">
        <CogIcon width="20px" color="textSubtle" />
      </IconButton>
    </Flex>
  );
};
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setProps({
        ...
        setLang: noop,
        currentLang: "EN",
        huskiPriceUsd: Number(0.023158668932877668?.toFixed(2)),
        links,
        profile: null,
        userMenu: <UserMenuComponent account="0xbdda50183d817c3289f895a4472eb475967dc980" />,
        globalMenu: <GlobalMenuComponent />,
